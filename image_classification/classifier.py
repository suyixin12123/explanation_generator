...
from model_fn import classifier 
...
flags.DEFINE_string(
    "model_dir",
    default=os.path.join(os.getenv("TEST_TMPDIR", "/tmp"), "classifier/"),
...
flags.DEFINE_string(
    "version",
    default="supervised vae 20181025_v2",
...
def main(argv):
    ...
    vae_model = classifier(IMAGE_SHAPE)
